...
const colorPresets = {
  "Tech Blue": {
    color1: [0.2, 0.616, 0.749], // rgb(51,157,191)
    color2: [0.192, 0.8, 0.941], // rgb(49,204,240)
    color3: [0.141, 0.502, 0.608] // rgb(36,128,155)
  },
  "Ocean Deep": {
    color1: [0.788, 0.922, 0.953], // rgb(201,235,243)
    color2: [0.192, 0.8, 0.941], // rgb(49,204,240)
    color3: [0.549, 0.706, 0.753] // rgb(140,180,192)
  },
  "Midnight": {
    color1: [0.141, 0.502, 0.608], // rgb(36,128,155)
    color2: [0.035, 0.251, 0.302], // rgb(9,64,77)
    color3: [0.024, 0.184, 0.227] // rgb(6,47,58)
  },
  "Crystal": {
    color1: [0.788, 0.922, 0.953], // rgb(201,235,243)
    color2: [0.549, 0.706, 0.753], // rgb(140,180,192)
    color3: [0.2, 0.616, 0.749] // rgb(51,157,191)
  },
  "Pure Monochrome": {
    color1: [1.0, 1.0, 1.0],
    color2: [1.0, 1.0, 1.0],
...
const fragmentShader = `
      ...
      void main() {
        ...
        // Only render the effect, no background
        if (inCircle <= 0.0) {
          discard; // Don't render anything outside the circle
        }
